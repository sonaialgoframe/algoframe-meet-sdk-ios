...
@interface AlgoframeMeet : NSObject
 ...
 * with those passed to AlgoframeMeetView.join when joining a conference.
 */
@property (nonatomic, nullable) AlgoframeMeetConferenceOptions *defaultConferenceOptions;

/**
 * Custom RTCAudioDevice implementation.
 * https://github.com/algoframe/webrtc/blob/M124/sdk/objc/components/audio/RTCAudioDevice.h
...
- (AlgoframeMeetConferenceOptions *_Nonnull)getInitialConferenceOptions;
