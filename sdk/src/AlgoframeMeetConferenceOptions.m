...
#import "AlgoframeMeetUserInfo+Private.h"

@implementation AlgoframeMeetConferenceOptionsBuilder {
...
@implementation AlgoframeMeetConferenceOptions {
...
- (instancetype)initWithBuilder:(AlgoframeMeetConferenceOptionsBuilder *)builder {
    if (self = [super init]) {
...
+ (instancetype)fromBuilder:(void (^)(AlgoframeMeetConferenceOptionsBuilder *))initBlock {
    AlgoframeMeetConferenceOptionsBuilder *builder = [[AlgoframeMeetConferenceOptionsBuilder alloc] init];
    initBlock(builder);
    return [[AlgoframeMeetConferenceOptions alloc] initWithBuilder:builder];
}
