...
#import "AlgoframeAudioSession+Private.h"
...
typedef enum {
    ...
    kAudioModeAudioCall,
    kAudioModeVideoCall
} AlgoframeMeetAudioMode;

// Events
static NSString * const kDevicesChanged = @"org.algoframe.meet:features/audio-mode#devices-update";
...
@implementation AudioMode {
    AlgoframeMeetAudioMode activeMode;
...
- (instancetype)init {
    ...
    if (self) {
        ...
        RTCAudioSession *session = AlgoframeAudioSession.rtcAudioSession;
