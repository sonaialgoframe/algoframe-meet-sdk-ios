...
#import "AlgoframeMeetUserInfo.h"


@interface AlgoframeMeetConferenceOptionsBuilder : NSObject
...
/**
 * Feature flags. See: https://github.com/algoframe/algoframe-meet/blob/master/react/features/base/flags/constants.js
 */
 ...
 */
@property (nonatomic, nullable) AlgoframeMeetUserInfo *userInfo;
...
@interface AlgoframeMeetConferenceOptions : NSObject
...
+ (instancetype _Nonnull)fromBuilder:(void (^_Nonnull)(AlgoframeMeetConferenceOptionsBuilder *_Nonnull))initBlock;
