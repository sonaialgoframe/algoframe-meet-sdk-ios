...
// Events
static NSString * const hangUpAction = @"org.algoframe.meet.HANG_UP";
static NSString * const setAudioMutedAction = @"org.algoframe.meet.SET_AUDIO_MUTED";
static NSString * const sendEndpointTextMessageAction = @"org.algoframe.meet.SEND_ENDPOINT_TEXT_MESSAGE";
static NSString * const toggleScreenShareAction = @"org.algoframe.meet.TOGGLE_SCREEN_SHARE";
static NSString * const retrieveParticipantsInfoAction = @"org.algoframe.meet.RETRIEVE_PARTICIPANTS_INFO";
static NSString * const openChatAction = @"org.algoframe.meet.OPEN_CHAT";
static NSString * const closeChatAction = @"org.algoframe.meet.CLOSE_CHAT";
static NSString * const sendChatMessageAction = @"org.algoframe.meet.SEND_CHAT_MESSAGE";
static NSString * const setVideoMutedAction = @"org.algoframe.meet.SET_VIDEO_MUTED";
static NSString * const setClosedCaptionsEnabledAction = @"org.algoframe.meet.SET_CLOSED_CAPTIONS_ENABLED";
static NSString * const toggleCameraAction = @"org.algoframe.meet.TOGGLE_CAMERA";
static NSString * const showNotificationAction = @"org.algoframe.meet.SHOW_NOTIFICATION";
static NSString * const hideNotificationAction = @"org.algoframe.meet.HIDE_NOTIFICATION";
static NSString * const startRecordingAction = @"org.algoframe.meet.START_RECORDING";
static NSString * const stopRecordingAction = @"org.algoframe.meet.STOP_RECORDING";
static NSString * const overwriteConfigAction = @"org.algoframe.meet.OVERWRITE_CONFIG";
static NSString * const sendCameraFacingModeMessageAction = @"org.algoframe.meet.SEND_CAMERA_FACING_MODE_MESSAGE";
