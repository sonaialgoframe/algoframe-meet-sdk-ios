...
class ExtensionDelegate: NSObject, WCSessionDelegate, WKExtensionDelegate {
    ...
    var currentContext : AlgoframeMeetContext = AlgoframeMeetContext()

    static var currentAlgoframeMeetContext: AlgoframeMeetContext {
        get {
    ...
    func session(_ session: WCSession, didReceiveApplicationContext applicationContext: [String : Any]) {
        DispatchQueue.main.async {
            let newContext = AlgoframeMeetContext(context: applicationContext)
